...
window.addEventListener("load", function(){
	...
	document.querySelectorAll('input[type="radio"]').forEach((e) => {e.addEventListener('click', function(e){
		...
		if (e.hasAttribute('checked')) prefix = parseInt(e.getAttribute('prefix')); // find the default prefix in the HTML
	});
	...
	document.getElementById('submitbutton').addEventListener('click', function() {
		...
		console.log(`Resistance: ${resistance}*${prefix}Ω, Series: ${ActiveSeries}`);
